...
[ ]
[Figure 1] [good_outcome.png]

This data matches the distribution of ability scores and outcomes predicted by my theory.

In one MCMC run, the group level 95% credible intervals cover the true parameters values for 95% of cases.
[Figure 2] (good_validation.png)

After RSP, the trace plots suggest that the model is well identified:

[Figure 3] (good_trace.png)
