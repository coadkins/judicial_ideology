...
My solution is adopt the IRT model first used by Martin & Quinn but to reject its content-agnosticism. Like Epstein I code cases along a left, right dimension so that the results can be interpreted politically meaningfully. However, unlike Epstein, I do not code using textual analysis, but by relying on information about the case's legal category, it's parties and its outcome. This allows me to scale the analysis to cover all federal court judges appointed between 1988 and 2020 and to interpret the results politically substantively. Finally, it avoids the tenuous connection between case outcomes and judge's behaviors outside the bench. However, consistent with Lauderdale and Clark's critique of low-dimensional models, it relies on an arbitrary assignment of case outcomes to interpretive categories--in my case, cultural and economic conservatism. To overcome this, I justify my choice of dimensions theoretically, but also by using a confirmatory factor analysis.

# Lopsided Polarization Among Federal Judges

<< Polarization is a thing in brief >> However,  

Federal judges rely on popularly elected politicians for the their job appointments, which require the President's nomination and the Senate's approval. Because of this closeness to electoral politics, we should expect judicial ideology to track executive and Senatorial policy preferences, as well as the interests of some other organized actors like lawyer Bar Associations.[@bonicaJudicialTugWar2020] How closely these preferences match will vary idiosyncratically because appointments follow the irregular timing of judicial retirement and death.  

When American politics is conceived along a single, left-right dimension, judicial preferences generally track shifting Presidential and Congressional preferences - including the recent trend towards polarization. Bonica and Sen estimate that, between federal judges appointed by Democrat and Republican presidents, the ideological distance -- in this case, as measured by contributions to political campaigns -- has increased commeasureately with the same increase in Congress. [@bonicaJudicialTugWar2020] This trend is particularly pronounced at the level of the Supreme Court, where the small number of justices permits close observation of partisan trends. Under any number of measures, from political campaign contributions to voting records, the Supreme Court is as polarized as it has ever been in the post-war period. [@bonicaEstimatingJudicialIdeology2021; @bonicaJudicialTugWar2020; @hasenPolarizationJudiciary2019] 

However, the polarization of the present moment depends upon a coalitional realignment in the late 20th century within both the Republican and Democratic parties. This realignment took place along (at least) two-dimensions: an economic one, which includes redistributive taxation but also labor market regulation and antitrust policy, and a social one, which includes legal protections for racial, gender and sexual minorities. [@hackerLetThemEat2020] As the [@hackerLetThemEat2020] -- now aliented by party platforms -- , by "progressive neoliberalism," which included strong commitments to trade liberalization,  The few efforts to study judicial polarization tend to lump these issue spaces together, and therefore miss  . When pro-business, , with far less attention (in both qualitative and quantitative work) 

Social conservatives. 

The Federalist Society operated at the center of the so-called "conservative legal movement" -- a loose group of business associations, public interest litigation, judges and legal academics which since the 1970s have pursued broad transformations in antitrust, labor law, and civil rights, among other areas. [@telesRiseConservativeLegal2012; @burbankRightsRetrenchment2017; @winklerWeCorporationsHow2018; @kaganAdversarialLegalismAmerican2019] See also Keck, 

<< more on polarization >> What the philosopher Nancy Fraser calls "progressive neoliberalism," which is defined by ... [@fraser1702EndofProgressiveNeoliberalism] 

Among judges appointed by Democratic presidents, << the story is far less clear >. Perhaps this is because of the lack of single dominating interest group, in contrast to the role played by the Federalist Society in the Republican party. 

The exception to this is Epstein, who has << emphasized while coming up with evidence for Democrats also >> . << Alot of current evidence suggests that these judges went right also >>

# Judicial Ideology and Litigant Politics

in other work, I call this phenomenon *litigant politics*. [^1] In litigant politics, organized interests pursue legal transformations across America's patchwork of state and federal court jurisdictions, often carried out in concert with traditional lobbying and political mobilization strategies.
...
[^1]: I'll cite to my second paper in the set of three, which covers this concept in more depth.  